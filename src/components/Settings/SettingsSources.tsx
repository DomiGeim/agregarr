...
const messages = defineMessages({
  ...
  myanimelistApiKeyTip:
    'Get your API key from <code>https://myanimelist.net/apiconfig</code> and copy the <code>Client ID</code>. Critical fields: App Type - <code>Web</code>, App Redirect URL - <code>http://localhost/</code>, Homepage URL - <code>https://github.com/DomiGeim/agregarr</code>, <code>Non-Commercial</code>, <code>Hobbyist</code>.',
